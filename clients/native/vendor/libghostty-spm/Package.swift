...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "libghostty",
            url: "https://unpeel.com/releases/stable/vendor/GhosttyKit-2da015cd-unpeel-fdf68f0.xcframework.zip",
            checksum: "a2a7e318cf48baa30086e03252e034a3e74709c8b50df16641f4053c8fb93ead"
        ),
        .testTarget(
            name: "GhosttyKitTest",
